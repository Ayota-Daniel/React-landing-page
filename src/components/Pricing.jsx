       ...
       <div name="pricing" className='w-full text-white my-24'>
           ...
           <div className='max-w-[1240px] mx-auto py-12'>
               <div className='text-center py-8 text-slate-300'>
                   ...
                   <h3 className='text-5xl font-bold text-white py-8'>The right price for for your research</h3>
                   <p className='text-3xl'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Harum ad rerum fugit repudiandae quibusdam placeat sint eos corrupti cum explicabo voluptatum in, quis eius magni saepe consequatur officiis at accusantium.</p>
               </div>
